...
public class BookTest {
  ...
  Book book = new Book ("The Catcher in the Rye", "J. D. Salinger", "Literature");
  ...
  public void Book_instantiatesWithTitle_String() {
    Book testBook = book;
    assertEquals("The Catcher in the Rye", testBook.getTitle());
  }

  @Test
  public void Book_instantiatesWithAuthor_String() {
    Book testBook = book;
    assertEquals("J. D. Salinger", testBook.getAuthor());
  }
...
//       Monster firstMonster = new Monster("Squeaky", 1);
//       firstMonster.save();
...
//     testPerson.save();
//     Monster testMonster = new Monster("Squeaky", testPerson.getId());
//     testMonster.save();
